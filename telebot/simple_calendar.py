...
class SimpleCalendar:
    ...
    async def start_calendar(
        ...
        inline_kb.insert(InlineKeyboardButton(
            "<<",
            callback_data=calendar_callback.new("PREV-MONTH", year, month, 1) #("PREV-MONTH", year, month, day)
        ))
        inline_kb.insert(InlineKeyboardButton(
        ...
        inline_kb.insert(InlineKeyboardButton(
            ">>",
            callback_data=calendar_callback.new("NEXT-MONTH", year, month, 1) # ("NEXT-MONTH", year, month, day)
        ))
